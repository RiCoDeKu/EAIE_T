...
const DrawerContainer: React.FC<DrawerContainerProps> = ({
  ...
  <DrawerHeader className="text-center ml-[-450px]">
    {/* タイトル・ヘッダー */}
    <DrawerTitle className="text-4xl font-bold text-slate-200">{title}</DrawerTitle>

    {/* 入力フィールド*/}
    <DrawerDescription asChild className="outerBox w-full max-w-md space-y-4 text-black">
      <div>{children}</div>
    </DrawerDescription>
